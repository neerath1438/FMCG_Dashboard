...
def process_chatbot_query(question, session_id="default"):
    ...
    if any(keyword in question_lower for keyword in ["what is this", "how to use", "help", "guide", "tutorial", "benefits"]):
        # [Keep existing help text for brevity in this script, or re-insert it]
        return {
            "answer": "This is the FMCG Product Mastering Platform...", # Shortened for script
            "data": [],
            "query_used": {},
            "result_count": 0,
...
2. MARKET AWARENESS: PM=Pen Malaysia, EM=East Malaysia, MT=Modern Trade, 7-Eleven=Total 7-Eleven (Market).
...
print("Updated chatbot.py with Hybrid Logic")
