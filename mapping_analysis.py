...
FLAVOUR_CONFLICTS = [
    ...
    "GOGUMA", "CORN", "ROASTED CORN", "PINK LAVA", "HONEY", "MIX BERRY",
    "DARK CHOCO", "PEANUT BUTTER", "SALTED", "VANILLA", "MATCHA"
]
...
BRAND_RULES = {
    ...
    "NABATI": {
        "SUB_BRANDS": ["NEXTAR", "RICHEESE", "RICHOCO", "PINK LAVA", "SIIP", "AHH", "BITES", "MALKIZ", "VITAKRIM", "BIG ROLL", "GATITO", "SIMBA", "GOGUMA"],
        "BIDIRECTIONAL_KEYWORDS": ["NEXTAR", "RICHEESE", "RICHOCO", "PINK LAVA", "SIIP", "AHH", "BITES", "MALKIZ", "VITAKRIM", "BIG ROLL", "GATITO", "SIMBA", "GOGUMA", "WAFER", "BROWNIE"]
    },
    "BOURBON": {
        "SUB_BRANDS": ["FETTUCCINE", "PAKILA", "EVERY BURGER", "DIGESTIVE", "ALFORT", "ELISE", "ROANNE", "LUMANDE"],
        "BIDIRECTIONAL_KEYWORDS": ["FETTUCCINE", "GUMMY", "PAKILA", "BURGER", "DIGESTIVE", "ALFORT", "ELISE", "ROANNE", "LUMANDE", "PETIT"]
    },
    "LEXUS": {
        "SUB_BRANDS": ["MINI", "CRACKER", "COOKIES", "CHOCO COATED", "SANDWICH", "SALTED"],
        "BIDIRECTIONAL_KEYWORDS": ["MINI", "SALTED", "CHOCO COATED", "SANDWICH", "COOKIES", "DARK", "ORIGINAL"]
    }
}
